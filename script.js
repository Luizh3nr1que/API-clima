document.querySelector('.busca').addEventListener('submit', async (event) => {
    ...
    if (input !== '') {
        ...
        let results = await fetch(`https://api.openweathermap.org/data/2.5/weather?q=${encodeURI(input)}&appid=171b165c1d7106064b4ca3c9a08f84fc&units=metric&lang=pt_br`);
